...
The project works with React, JSX, React Router, React Context API, and Create React App.
The CSS was changed from the original colour of violet to green in different shades, and the layout of the detail pages has been improved.
